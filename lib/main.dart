...
import 'package:flutter_app/lunchPredictor/theme/style.dart' as lpStyle;
import 'package:flutter_app/lunchPredictor/screens/main.dart' as lpMain;
  ...
  runApp(
    MaterialApp(
      ...
      routes: {
        ...
        '/lunchPredictor': (context) => new lpMain.LunchPredictorMain(),
      },
    )
  );
}
