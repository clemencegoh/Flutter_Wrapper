...
///
/// Using the default ReorderableListView breaks when used inside something with an existing ScrollController
///
/// This class is essentially the same as the original ReorderableListView but with its own ScrollController
...
class _ReorderableListViewState extends State<CustomReorderableListView> {
  ...
  final GlobalKey _overlayKey = GlobalKey(debugLabel: '$CustomReorderableListView overlay key');
